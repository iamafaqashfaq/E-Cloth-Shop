...
{
	$pass = $_POST['password'];
$sql=mysqli_query($con,"SELECT password FROM  admin where password='".$pass."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
	$newpass = $_POST['newpassword'];
 mysqli_query($con,"update admin set password='".$newpass."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
