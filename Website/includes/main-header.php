				...
				<div class="col-xs-12 col-sm-12 col-md-1">
					<div class="logo">
						<a href="index.php">
							...
							<img src="img/logo.png" class="img-rounded" alt="error" height="90px;" width="90px;" style=" border-radius: 75px;">
		</a>
	</div>
				</div>
...
<div class="logo">
	<a href="index.php">
		...
		<h2 style="font-family:verdana; color:#ABD07E; padding-top: 10px;">E-Cloth Shop</h2>
	</a>
</div>		
</div>
      <!--- ======================== SEARC AREA==================================--->
      
<div class="col-xs-12 col-sm-12 col-md-4 top-search-holder" style="padding-top: 30px;">
...
<!-- ================================================ SEARCH AREA : END ===================================== -->			
				...
				<div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row" style="padding-top: 40px;">
